...
const {
  VERITAS_SECRET = 'lk*%RTIYOUHGJasfjl(&^E$RYUIJHUGFJH',
  VERITAS_ENCRYPTION_ALGORITHM = 'aes256',
  VERITAS_SALT = 'my random salt',
  VERITAS_SALT_KEY_LENGTH = '32',
  VERITAS_IV = 'myrandomivisntlongenough',
  VERITAS_IV_LENGTH = '16',
  VERITAS_USE_RANDOM_IV = 'false',
} = process.env
...
export const encrypt = (envFile, destination) => {
  ...
  const vars = Object.fromEntries(envData.split('\n').map((e) => e.split('=')))
